...
1. When Terraform and/or rancher and/or helm are used for managing single cluster be aware of annotations ownership and drift detection, so terraform would not rollback rancher's ones.
